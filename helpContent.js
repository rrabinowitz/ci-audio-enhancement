  ...
  'mobile-layout': {
    ...
    body: `
      ...
      <ul>
        ...
        <li><strong>Single-column stack</strong> — panels stack vertically: Transport → 16-channel Visualizer → Enhancement Controls → (collapsed by default) Auto-Tune, Electrode Map, Diagnostic Vocoder. The visualizer sits right under Transport so meters are easy to find while playing.</li>
...
export const MENU_CONTENT = {
  ...
  faq: {
    ...
    body: `
      ...
      <p>By design. On phones, menus collapse behind <strong>☰ Menu</strong> and panels stack in a single column — Transport, then the 16-channel Visualizer, then Enhancement Controls, then the optional lower panels. On screens about 1100px wide, the same page expands into a <strong>two-column dashboard</strong> — Transport and Enhancement Controls full width above the visualizer; Auto-Tune, Electrode Map, and Diagnostic Vocoder side-by-side below. Collapsible sections remember whether you left them open. See ⓘ <strong>Layout, Mobile &amp; PWA</strong> in the quick-start callout.</p></div>
